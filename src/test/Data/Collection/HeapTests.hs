...
heapTests :: (Heap h, Arbitrary a, Show a, Ord a) => h a -> String -> Test
...
prop_emptyInsert :: (Heap h, Eq a) => h a -> a -> Bool
...
prop_sortedUnfold :: (Heap h, Ord a) => h a -> NonEmptyList a -> Bool
